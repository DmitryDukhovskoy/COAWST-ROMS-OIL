...
!cjw---
            CASE('Vp1')
              Npts=load_r(Nval, Rval, Ngrids, Vp1)
            CASE ('gnp2')
              Npts=load_r(Nval, Rval, Ngrids, gnp2)
            CASE ('gnp3')
              Npts=load_r(Nval, Rval, Ngrids, gnp3)
            CASE ('gnp4')
              Npts=load_r(Nval, Rval, Ngrids, gnp4)
            CASE ('BgMRs')
              Npts=load_r(Nval, Rval, Ngrids, BgMRs)
            CASE ('BgMRa')
              Npts=load_r(Nval, Rval, Ngrids, BgMRa)
            CASE ('BgMRr')
              Npts=load_r(Nval, Rval, Ngrids, BgMRr)
            CASE ('K_bg2')
              Npts=load_r(Nval, Rval, Ngrids, K_bg2)
            CASE ('K_bg3')
              Npts=load_r(Nval, Rval, Ngrids, K_bg3)
            CASE ('K_bg4')
              Npts=load_r(Nval, Rval, Ngrids, K_bg4)
            CASE ('K_Sat')
              Npts=load_r(Nval, Rval, Ngrids, K_Sat)
            CASE ('K_Arom')
              Npts=load_r(Nval, Rval, Ngrids, K_Arom)
            CASE ('K_Resin')
              Npts=load_r(Nval, Rval, Ngrids, K_Resin)
            CASE ('econsta_S')
              Npts=load_r(Nval, Rval, Ngrids, econsta_S)
            CASE ('econsta_A')
              Npts=load_r(Nval, Rval, Ngrids, econsta_A)
            CASE ('econsta_R')
              Npts=load_r(Nval, Rval, Ngrids, econsta_R)
            CASE ('szbg2')
              Npts=load_r(Nval, Rval, Ngrids, szbg2)
            CASE ('szbg3')
              Npts=load_r(Nval, Rval, Ngrids, szbg3)
            CASE ('szbg4')
              Npts=load_r(Nval, Rval, Ngrids, szbg4)
            CASE ('betab')
              Npts=load_r(Nval, Rval, Ngrids, betab)
            CASE ('betap')
              Npts=load_r(Nval, Rval, Ngrids, betap)
            CASE ('betas2')
              Npts=load_r(Nval, Rval, Ngrids, betas2)
            CASE ('betas3')
              Npts=load_r(Nval, Rval, Ngrids, betas3)
            CASE ('betas4')
              Npts=load_r(Nval, Rval, Ngrids, betas4)
!cjw---
            CASE ('TNU2')
