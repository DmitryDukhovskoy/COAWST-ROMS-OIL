...
!cjw---
              ...
              CASE ('idTbry(iwest,ibg2)')
                idTbry(iwest,ibg2)=varid
              CASE ('idTbry(ieast,ibg2)')
                idTbry(ieast,ibg2)=varid
              CASE ('idTbry(isouth,ibg2)')
                idTbry(isouth,ibg2)=varid
              CASE ('idTbry(inorth,ibg2)')
                idTbry(inorth,ibg2)=varid

              CASE ('idTbry(iwest,ibg3)')
                idTbry(iwest,ibg3)=varid
              CASE ('idTbry(ieast,ibg3)')
                idTbry(ieast,ibg3)=varid
              CASE ('idTbry(isouth,ibg3)')
                idTbry(isouth,ibg3)=varid
              CASE ('idTbry(inorth,ibg3)')
                idTbry(inorth,ibg3)=varid

              CASE ('idTbry(iwest,ibg4)')
                idTbry(iwest,ibg4)=varid
              CASE ('idTbry(ieast,ibg4)')
                idTbry(ieast,ibg4)=varid
              CASE ('idTbry(isouth,ibg4)')
                idTbry(isouth,ibg4)=varid
              CASE ('idTbry(inorth,ibg4)')
                idTbry(inorth,ibg4)=varid
!cjw----
#ifdef CARBON
