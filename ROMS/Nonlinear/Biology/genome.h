...
#if defined CARBON && defined ADDOIL
...
!XCHEN ADDOIL MMMM2
                ...
                Bio(i,k,iSat)=Bio(i,k,iSat)/(1.0_r8+coo5)

                SAT_Flux_RegProd=Bio(i,k,iSat)*coo5
                ...
                Bio(i,k,iResin)=Bio(i,k,iResin)/(1.0_r8+cbb5)

                RESIN_Flux_RegProd=Bio(i,k,iResin)*cbb5*(16/106)*10
                                !N:C=16:106, 1 sat oil contain 10 C
