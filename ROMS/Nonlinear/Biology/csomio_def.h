...
!cjw---
      Vinfo( 1)='gnp2'
      Vinfo( 2)='penalty on maximum growth rate on bg1'
      Vinfo( 3)='day-1'
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
     ...
     &               __FILE__)) RETURN
      ...
      Vinfo( 1)='gnp3'
      Vinfo( 2)='penalty on maximum growth rate'
      Vinfo( 3)='day-1'
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
     ...
     &               __FILE__)) RETURN
      ...
      Vinfo( 1)='K_bg2'
      Vinfo( 2)='inverse bug2 half saturation for zooplankton'
      Vinfo( 3)='meter3 millimole_N-1'
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
     ...
     &               __FILE__)) RETURN
      ...
      Vinfo( 1)='K_bg3'
      Vinfo( 2)='inverse bug3 half saturation for zooplankton'
      Vinfo( 3)='meter3 millimole_N-1'
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
     ...
     &               __FILE__)) RETURN
      ...
      Vinfo( 1)='K_bg4'
      Vinfo( 2)='inverse bug4 half saturation for zooplankton'
      Vinfo( 3)='meter3 millimole_N-1'
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
     ...
     &               __FILE__)) RETURN
      ...
      Vinfo( 1)='K_Sat'
      Vinfo( 2)='inverse half saturation'
      Vinfo( 3)='meter3 millimole_C-1'
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
      IF (FoundError(exit_flag, NoError, __LINE__,                      &
     &               __FILE__)) RETURN
      ...
      Vinfo( 1)='K_Arom'
      Vinfo( 2)='inverse arom half saturation'
      Vinfo( 3)='meter3 millimole_C-1'
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
     ...
     &               __FILE__)) RETURN
      ...
      Vinfo( 1)='K_Resin'
      Vinfo( 2)='inverse resin half saturation'
      Vinfo( 3)='meter3 millimole_C-1'
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
     ...
     &               __FILE__)) RETURN
      ...
      Vinfo( 1)='econsta_S'
      Vinfo( 2)='energy constant for limitation'
      Vinfo( 3)='none'
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
