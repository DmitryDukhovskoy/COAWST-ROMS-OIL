...
! XCHEN MMMM
#ifdef ADDZX
      integer :: iZx                  ! index of zx concentration added by xu chen
#endif
! XCHEN WWWW
...
#ifdef OIL_BIO
      integer :: iSbug1                 ! sbug concentration
      integer :: iSbug2                 ! sbug concentration
      integer :: iSbug3                 ! sbug concentration
      integer :: iSbug4                 ! sbug concentration
      integer :: iLbug1                 ! lbug concentration
      integer :: iLbug2                 ! lbug concentration
...
!#ifdef OILBUGS  DDMITRY
#ifdef OIL_BIO
      real(r8), allocatable :: K_SAT(:)              ! m3/mmol
      real(r8), allocatable :: K_Arom(:)             ! m3/mmol
      real(r8), allocatable :: K_Resin(:)            ! m3/mmol
      real(r8), allocatable :: K_SBUG1(:)              ! m3/mmol
      real(r8), allocatable :: K_SBUG2(:)              ! m3/mmol
      real(r8), allocatable :: K_SBUG3(:)              ! m3/mmol
      real(r8), allocatable :: econsta_S(:)          ! m3/mmol
      real(r8), allocatable :: econsta_A(:)          ! m3/mmol
      real(r8), allocatable :: econsta_R(:)          ! m3/mmol
#endif
!XCHEN OILBUGS WWWW
...
!#ifdef OILBUGS DDMITRY
      ...
      END IF
      IF (.not.allocated(K_SBUG1)) THEN
        allocate ( K_SBUG1(Ngrids) )
      END IF
      IF (.not.allocated(K_SBUG2)) THEN
        allocate ( K_SBUG2(Ngrids) )
      END IF
      IF (.not.allocated(K_SBUG3)) THEN
        allocate ( K_SBUG3(Ngrids) )
      END IF
