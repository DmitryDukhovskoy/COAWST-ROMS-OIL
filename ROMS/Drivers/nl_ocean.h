...
#ifdef FLOAT_OIL
! DDMITRY
      USE oil_floats_mod,    ONLY : oil_param_initialize
# ifdef DISTRIBUTE
...
#ifdef FLOAT_OIL
! DDMITRY
! Initialize fields for oil floats
...
!$OMP PARALLEL
#ifdef SOLVE3D
# if defined OFFLINE_BIOLOGY || defined OFFLINE_FLOATS || defined OFFLINE_TPASSIVE
