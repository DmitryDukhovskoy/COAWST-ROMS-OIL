...
export   EXPT=oil_03
export   COAWST_APPLICATION=${EXPT}
...
export   MY_ROOT_DIR=/gpfs/research/coaps/home/ddmitry/COAWST/trunk
...
#  export MY_ANALYTICAL_DIR=${MY_PROJECT_DIR}/ROMS/Functionals
   export     MY_HEADER_DIR=${MY_PROJECT_DIR}/Projects/${EXPT}
   export MY_ANALYTICAL_DIR=${MY_PROJECT_DIR}/Projects/${EXPT}
